...
<head>
    <meta charset="UTF-8">
    <title>CV. New Garuda Totabuan | Rental</title>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-sm-8 col-md-7 py-4">
                        ...
                        <p class="text-white">CV. New Garuda Totabuan adalah UKM yang bergerak dibidang jasa transportasi.</p>
                    </div>
                    <div class="col-sm-4 offset-md-1 py-4">
                        <h4 class="text-white">Contact</h4>
                        <ul class="list-unstyled">
                            <li><span class="text-white">081524605468</span></li>
                        </ul>
                    </div>
                </div>
            </div>
