...
<main role="main">
    ...
    <section class="jumbotron text-center">
        <div class="container">
            ...
            <p class="lead text-muted">Untuk memesan tiket silahkan login terlebih dahulu. Jika belum punya akun segera lakukan pendaftaran.</p>
            <p>
                        ...
                        <div class="card mb-4 box-shadow">
                            ...
                            <div class="card-body">
                                <p class="card-text font-weight-bold text-secondary">
                                    <h5><?php echo $mt->merek.' ( '.$mt->plat_nomor.' ) '; ?></h5>
                                </p>
                                <?php foreach($kursi_tersedia as $kt){ ?>
                                    <?php if($mt->plat_nomor == $kt->plat_nomor){ ?>
                                        <?php echo '<span class="font-italic text-secondary"> Kursi '.$kt->nomor_kursi.' : </span>'; ?><?php if($kt->status_order == 0) echo '<span class="fa fa-check text-success"></span>'; else  echo '<span class="fa fa-times text-danger"></span>' ; ?><br />
                                    <?php  } ?>
                                <?php  } ?>
                                <hr>
                                <small class="text-muted">
                                    <span class="text-danger">Ket :</span><br />
